    ...
    <div class="container mx-auto">
        <div class="py-1">
            <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="bg-green-100 border mb-3 border-green-400 text-green-700 px-4 py-3 rounded relative"
                    role="success">
            ...
            <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <div class="text-gray-700 text-base text-xl px-6 pb-4 border-b">Create new Video</div>
                        <form method="POST" action="{{ route('videos.store') }}" enctype="multipart/form-data">
                            ...
                            <div>
                                ...
                                <input id="link"
                                    ...
                                    type="text" name="link" value="{{old('link')}}" autocomplete="name" />
                                @error('link')
                                <div class="text-red-400">
                                    {{ $message }}
                                </div>
