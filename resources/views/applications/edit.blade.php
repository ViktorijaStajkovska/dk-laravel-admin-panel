<x-app-layout>
            ...
            <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <div class="text-gray-700 text-base text-xl px-6 pb-4 border-b">Edit application</div>
                        <form class="space-y-6" id="application-form"
                            action="{{ route('applications.update', $application)}}" method="POST"
                            ...
                            <div>
                                ...
                                <input type="text" name="name" id="name"
                                    ...
                                    placeholder="name" value="{{old('name', $application->name)}}" required>
                                @error('name')
                            ...
                            <div>
                                ...
                                <input type="text" name="surname" id="surname"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                                    placeholder="surname" value="{{old('surname', $application->surname)}}" required>
                                @error('surname')
                                <div class="text-red-400">
                                    {{ $message }}
                                </div>
                            ...
                            <div>
                                ...
                                <input type="email" name="email" id="email"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                                    placeholder="email" value="{{old('email', $application->email)}}" required>
                                @error('email')
                                <div class="text-red-400">
                                    {{ $message }}
                                </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="phone" id="phone"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                                    placeholder="phone" value="{{old('phone', $application->phone)}}" required>
                                @error('phone')
                                <div class="text-red-400">
                                    {{ $message }}
                                </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="city" id="city"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                                    placeholder="city" value="{{old('city', $application->city)}}" required>
                                @error('city')
                                <div class="text-red-400">
                                    {{ $message }}
                                </div>
                            ...
                            <div>
                                ...
                                <input type="file" name="attachment1" id="attachment1"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                                    placeholder="attachment1" required>
                                @error('attachment1')
                                <div class="text-red-400">
                                    {{ $message }}
                                </div>
                                ...
                                <div class="mt-3">
                                    <a href="{{ Storage::url($application->attachment1) }}" target="_blank">
                                        <i class="text-lg  text-gray-800 fa-solid fa-file-lines fa-beat"></i>
                                        attachment1
                                    </a>
                                </div>
                                @endif
                            ...
                            <div>
                                ...
                                <div class="mt-3">
                                    <a href="{{ Storage::url($application->attachment2) }}" target="_blank">
                                        <i class="text-lg  text-gray-800 fa-solid fa-file-lines fa-beat"></i>
                                        attachment2
                                    </a>
                                </div>
                            ...
                            <div>
                                ...
                                <textarea cols="30" rows="3" id="description"
                                    ...
                                    type="text" name="description" value="old('description', $application->description)"
                                    required autofocus
                                    autocomplete="description">{{old('description', $application->description)}}</textarea>
                                @error('description')
                                <div class="text-red-400">
                                    {{ $message }}
                                </div>
                            ...
                            <div id="content2">
                                ...
                                <select id="computer_equipment_id"
                                    ...
                                    <option value="{{ $computer_equipment2->id }}" @selected($computer_equipment2->
                                        computer_equipment_id==$computer_equipment2->id)>{{ $computer_equipment2->name }}
                                    </option>
                                    @endforeach
                                </select>
    ...
    @section('script')
    <script src="{{asset('./js/applications/application-edit.js')}}"></script>
    @endsection
</x-app-layout>